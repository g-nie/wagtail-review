...
urlpatterns = [
    ...
    path(
        "autocomplete_users/", admin_views.autocomplete_users, name="autocomplete_users"
    ),
    ...
    path(
        "reviews/<int:review_id>/view/",
        admin_views.view_review_page,
        name="view_review_page",
    ),
    path(
        "reviews/<int:review_id>/close/", admin_views.close_review, name="close_review"
    ),
    path(
        "reviews/<int:review_id>/close_and_publish/",
        admin_views.close_and_publish,
        name="close_and_publish",
    ),
    path(
        "reviews/<int:review_id>/reopen/",
        admin_views.reopen_review,
        name="reopen_review",
    ),
]
